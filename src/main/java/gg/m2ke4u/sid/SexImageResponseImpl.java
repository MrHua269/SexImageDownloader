...
public class SexImageResponseImpl {
    ...
    public SexImageResponseImpl(String error, Data[] data){
        this.error = error;
        this.data = data;
    }
    ...
    public static SexImageResponseImpl getNew(boolean r18) throws IOException {
        ...
        if (connection.getResponseCode() == 200) {
            ...
            return gson.fromJson(new String(buffer), SexImageResponseImpl.class);
        }
        throw new IOException("Connect response code:"+connection.getResponseCode());
    }

    public static SexImageResponseImpl getNew(boolean r18, String[] tags) throws IOException {
        String origanl = API_URL;
        if (r18) {
            origanl += "?r18=1";
        }
    ...
    public static CompletableFuture<SexImageResponseImpl> getNewAsync(boolean r18, String[] tags){
        return CompletableFuture.supplyAsync(()->{
            try {
                return SexImageResponseImpl.getNew(r18,tags);
            } catch (IOException e) {
                LogManager.getLogger().error(e);
                e.printStackTrace();
            }
    ...
    public static CompletableFuture<SexImageResponseImpl> getNewAsync(boolean r18){
        return CompletableFuture.supplyAsync(()->{
            try {
                return SexImageResponseImpl.getNew(r18);
            } catch (IOException e) {
                LogManager.getLogger().error(e);
                e.printStackTrace();
            }
